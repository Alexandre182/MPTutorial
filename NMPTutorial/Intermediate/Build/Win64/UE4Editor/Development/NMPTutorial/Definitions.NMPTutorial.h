#undef NMPTUTORIAL_API
#undef NMPTUTORIAL_VTABLE
...
#define UE_PROJECT_NAME NMPTutorial
...
#define NMPTUTORIAL_VTABLE DLLEXPORT_VTABLE
#define NMPTUTORIAL_API DLLEXPORT
